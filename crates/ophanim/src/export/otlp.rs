//! OTLP (OpenTelemetry Protocol) export for ophanim metrics.
//!
//! Converts ophanim metric types into OTLP protobuf messages for export
...
mod tests {
    ...
    fn test_build_trace_export_request() {
        ...
        let request = build_trace_export_request(&resource, "ophanim", vec![otlp_span]);
